#ifndef __DL_ST7735_H__
#define __DL_ST7735_H__

#include "stm32f4xx_hal.h"

#include "DL_ST7735_fonts.h"
...
void ST7735_DrawFillRoundedRect(uint16_t x0, uint16_t y0, uint16_t x1, uint16_t y1, uint16_t radius, uint16_t color);
